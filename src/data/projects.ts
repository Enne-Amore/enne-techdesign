export const projects = [
  {
    ...
    targetAudience: {
      ...
      img: "cnbpb-populacao-nb",
      alt: "Ilustração de pessoas não-binárias representando a população não-binária da Paraíba",
      mobileWidth: "330",
      mobileHeight: "200",
      desktopWidth: "580",
      desktopHeight: "352",
  ...
  },
  {
    ...
    targetAudience: {
      ...
      img: "janai-amitaf-eventos",
      alt: "Colagem de várias fotos de Janai Amitáf em eventos artísticos, representando a diversidade de sua audiência",
      mobileWidth: "300",
      mobileHeight: "167",
      desktopWidth: "580",
      desktopHeight: "322",
    ...
    solution: {
      id: "solution-janai-amitaf",
      sectionStyle: "from-[#8C00FF] to-[#6C0CF2]",
      titleStyle: "font-bold text-[#F8F3FF] text-shadow-2xs",
      text: "Desenvolver um <strong>portfólio web</strong> que <strong>centralizasse e organizasse os trabalhos</strong> do artista de forma <strong>clara, atrativa e estratégica</strong>, permitindo que recrutadores e clientes:",
      textStyle: "text-[#F8F3FF]",
      list: [
        "Entendessem rapidamente seu perfil profissional",
        "Navegassem com facilidade entre diferentes projetos e serviços",
        "Identificassem seus principais trabalhos",
        "Encontrassem caminhos diretos para contato e contratação",
      ],
      img: "janai-amitaf-capas",
      alt: "Colagem de várias capas de projetos artísticos de Janai",
      mobileWidth: "300",
      mobileHeight: "345",
      desktopWidth: "400",
      desktopHeight: "460",
